...
This project requires GPU support to use [Unsloth](). However, using the T4 the is available for free in Colab should be sufficient, perhaps with a few adjustments to the hyperparameters to reduce batch size. was designed to be reproducible via Google Colab or using the SCC.
